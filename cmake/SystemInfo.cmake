...
function(target_for_var_name out_var _target)
    string(REPLACE "-" "_" _target_var "${_target}")
    set(${out_var} "${_target_var}" PARENT_SCOPE)
endfunction(target_for_var_name out_var _target)
